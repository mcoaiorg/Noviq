 ...
 * 
 * This module provides structured error handling for the NoviqBot application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw NoviqBotError for application-specific errors
...
export function categorizeError(error) {
    if (error instanceof NoviqBotError) {
        return error.type;
    }
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new NoviqBotError(message, type, userMessage, normalizedContext);
}
